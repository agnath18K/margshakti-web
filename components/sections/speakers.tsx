...
const speakersData = [
  ...
  { id: 6, name: "Invited Speaker #4", designation: "GMRCL", category: "Industry", initials: "IS4" },
  ...
  { id: 11, name: "Invited Speaker #9", designation: "MapmyIndia/Ola", category: "Industry", initials: "IS9" },
  { id: 12, name: "Invited Speaker #10", designation: "BlackBuck/Rivigo", category: "Industry", initials: "IS10" },
]
